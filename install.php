<?php 
	...
	$Modules_ = array(
		...
		array("mysqli_connect", "MySQLi", "apt-get install php5.6-mysql(i) / yum install php-mysqli"),
		array("mcrypt_encrypt", "Mcrypt", "apt-get install php5.6-mcrypt / yum install php-mcrypt"),
		//array("sqlite_open", "Sqlite", "apt-get install php5-sqlite / yum install php-sqlite"),
		array("gd_info", "GD", "apt-get install php5.6-gd / yum install php-gd"),
		array("gmp_mul", "GMP", "apt-get install php5.6-gmp / yum install php-gmp")	
	);
